...
const skills = [
  ...
  { name: "JavaScript", icon: <RiJavascriptLine />, proficiency: 50, color: "bg-gray-500" },
  { name: "React", icon: <FaReact />, proficiency: 60, color: "bg-indigo-500" },
  { name: "MongoDB", icon: <SiMongodb />, proficiency: 60, color: "bg-gray-800" },
  { name: "NextJS", icon: <TbBrandNextjs />, proficiency: 20, color: "bg-green-500" },
...
const SkillsSection = () => (
  <div id="skills" className="container mx-auto p-6 bg-white rounded-lg shadow-md">
    <h2 className="text-3xl font-bold mb-6 text-center text-blue-600">My Skills</h2>
