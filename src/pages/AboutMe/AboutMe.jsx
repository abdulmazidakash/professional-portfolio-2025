...
const AboutMe = () => {
  return (
    <motion.div 
      id='about' 
      className="container mx-auto px-4 sm:px-6 py-8 md:py-12 font-semibold"
    ...
    >
      ...
      <div className="text-center mb-6 md:mb-8">
        ...
        <motion.p 
          className="text-base md:text-lg text-gray-600 mt-1 md:mt-2"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-8">
        ...
        <motion.div 
          className="card bg-base-100 shadow-xl p-4 md:p-6 overflow-hidden"
